...
{
    public static HashSet<Vector2Int> SimpleRandomWalk(Vector2Int startPosition, int walkLength, int seed)
    {
        ...
        {
            currentPosition += Direction2D.GetRandomDirection(random);;
    ...
    public static List<Vector2Int> RandomWalkCorridor(Vector2Int startPosition, int corridorLength)
    {
        ...
        var direction = Direction2D.GetRandomDirection(new System.Random());
